...
import com.example.login.screen.LOGIN_BUTTON_TEST_TAG
...
class NavigationTest {
    ...
    fun moviesScreen_onLoad_addMoviesScreenToNavHost() {
        composeTestRule.apply {
            ...
            onNodeWithTag(LOGIN_BUTTON_TEST_TAG, useUnmergedTree = true)
                .onChildren()
                .onFirst()
                .performClick()

            Truth.assertThat(navController.currentDestination?.route).isEqualTo(loginRoutePattern)
